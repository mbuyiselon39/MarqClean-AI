...
export default function HeroCarousel({ onCleanFile, onSampleLeads, onOpenReconciliation }: HeroActions) {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -left-24 top-24 h-72 w-72 rounded-full bg-[#0D9488]/10 blur-3xl" aria-hidden="true" />
      <div className="pointer-events-none absolute -right-24 bottom-10 h-80 w-80 rounded-full bg-[#14B8A6]/15 blur-3xl" aria-hidden="true" />
        ...
        <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-8">
          ...
          <div key={`text-${current.key}`} className="mc-fade lg:col-span-5">
            <span className="mc-mono inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] uppercase text-teal-200">
              <span className="h-1.5 w-1.5 rounded-full bg-[#0D9488] shadow-[0_0_10px_#0D9488]" />
              {current.tag}
            </span>
