        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((tool) => (
            <PageLink
              key={tool.slug}
              page={tool.slug}
              className="group flex flex-col rounded-2xl border border-white/10 bg-white/[0.03] p-5 text-sm transition hover:border-[#0D9488]/50 hover:bg-white/[0.05] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0D9488]/50"
            >
...
function FooterContentPage({ page }: { page: FooterPage }) {
  return (
    <main id="main-content" className="min-h-screen bg-[#f6f3ec] px-5 pb-20 pt-32 lg:px-8">
      ...
      >
        <PageLink className="text-sm font-semibold text-teal-700 transition hover:text-slate-950" page="home">
          Back to product
        </PageLink>
        <p className="mt-8 text-sm font-semibold uppercase tracking-[0.28em] text-teal-700">{COMPANY_NAME}</p>
  ...
  return (
    <main id="main-content" className="min-h-screen bg-[#f6f3ec] px-5 pb-20 pt-32 lg:px-8">
      ...
      >
        ...
        <p className="mt-8 text-sm font-semibold uppercase tracking-[0.28em] text-teal-700">Free browser-based tool</p>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <a
            className="rounded-full bg-slate-950 px-6 py-3 text-center text-sm font-semibold text-white transition hover:bg-teal-700"
            href="/#cleaner"
            onClick={(event) => {
              event.preventDefault();
              navigateToPage("home");
        ...
        <section className="mt-16 border-t border-slate-200 pt-10">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-teal-700">{page.keyword}</p>
    ...
    <div className="min-h-screen bg-[#f6f3ec] text-slate-950">
      ...
      <main id="main-content">
        ...
        <section className="border-y border-white/10 bg-[#08090f] py-10 text-white">
          <div className="mx-auto grid max-w-6xl grid-cols-2 gap-6 px-5 sm:grid-cols-4 lg:px-8">
            {[
        ...
        <section id="features" className="mc-hero-root relative overflow-hidden border-y border-white/10 py-20 text-white">
          ...
          <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
            ...
            <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div className="mc-glass group rounded-2xl p-6 transition hover:border-[#0D9488]/40">
              ...
              <div className="mc-glass group rounded-2xl p-6 transition hover:border-[#14B8A6]/40">
